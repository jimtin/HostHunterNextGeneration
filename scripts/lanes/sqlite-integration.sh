...
module_path='/artifacts/build/HostHunterNextGeneration/0.1.0/HostHunterNextGeneration.psd1'

test -f "$artifact_root/build/HostHunterNextGeneration/0.1.0/HostHunterNextGeneration.psd1"
