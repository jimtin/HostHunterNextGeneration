...
| --- | --- | --- |
| Export/import | Package imports with exactly twelve public framework cmdlets; client adds two lifecycle commands; engine stays private | module and client contracts plus cmdlet receipt |
...
| Managed-host boundary | Six host-facing cmdlets delegate once to the closed engine; no bypass | AST guard and delegation tests |
